...
- Do not treat disabled live-adapter contract metadata as adapter construction
  ...
  decision-record, and adapter-invocation refs do not configure or construct
  adapters, record executable decisions, invoke adapters, execute adapters,
  call Coinbase, execute reconciliation, mutate futures state, or grant
  browser/BFF authority.
