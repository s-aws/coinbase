...
_HEX_GIT_OBJECT_ID = re.compile(r"[0-9a-f]{40}\Z")
...
_AUDIT_BINDING_REVISION_NAMES = _AUDIT_BINDING_SCALAR_NAMES[2:4]
_AUDIT_BINDING_SHA256_NAMES = _AUDIT_BINDING_SCALAR_NAMES[4:-1]
...
_R11_EXPECTED_COMPONENTS = frozenset(
    {
        ...
        "frontend:docs/COMMAND_WORKFLOWS.md",
        ...
        "frontend:docs/examples/futures-perpetuals-reads.md",
        ...
        "frontend:src/features/admin-shell/AdminShell.tsx",
        ...
        "frontend:src/shared/api/contracts/adminBffProxy.ts",
        "frontend:src/shared/api/contracts/backendApiClient.ts",
        "frontend:src/shared/api/contracts/backendRuntime.ts",
        ...
        "frontend:tests/e2e/mvp-bff-command.spec.ts",
        "frontend:tests/unit/FuturesPerpetualsReadModel.test.tsx",
        "frontend:tests/unit/FuturesOrderPreviewReadback.test.tsx",
        "frontend:tests/unit/adminBffProxy.test.ts",
...
def _literal_audit_binding_values(block: str) -> dict[str, object]:
    ...
    inactive = (
        ...
        and all(
            values[name] == ""
            for name in (
                *_AUDIT_BINDING_REVISION_NAMES,
                *_AUDIT_BINDING_SHA256_NAMES,
            )
        )
...
if False:
    ...
    R11_SAFETY_AUDIT_RECEIPT_SHA256 = "969d94dcad8dc5b475dacbaa8fa438538862f0427109e190a21cfebe3cbd22a0"
    R11_BLIND_AUDIT_RECEIPT_SHA256 = "75b088767d8348870d68252feb9110fb6caef38ad4edb7e9fb86043a1b728c0a"
    R11_ACTIVATION_NOT_AFTER = "2026-07-16T23:14:52Z"
    R11_AUDITED_COMPONENT_SHA256: dict[str, str] = {
        ...
        "backend:docs/FUTURES_SLICE_2R11_PREPARATION.md": "9ee57b2a8bd40df4dce38733d053b3f3ef3c6fa044661a552a25af6afb955381",
        ...
        "backend:tests/unit/test_run_admin_api_futures_no_live_preview_r11.py": "76498bdbe7324ac4c57ed4d769e5cd649150f6b652ab10391080056cabeb893d",
...
def _validate_final_audit_binding() -> None:
    ...
    if (
        ...
        or any(_HEX_GIT_OBJECT_ID.fullmatch(value) is None for value in revisions)
