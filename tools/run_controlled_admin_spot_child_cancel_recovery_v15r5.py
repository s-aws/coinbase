"""Prepare or execute the sealed V15R5 cancel-only recovery authority.

V15R5 cannot place a root or child. Preparation binds the completed V15R2/V15R3
lineage and both terminal failed V15R3/V15R4 proof runtimes, validates the local
active-child identity and authoritative Coinbase readback, then creates only
an owner-only schema-23 plan. Preparation exposes no runtime, marker, ledger,
...
FAILED_V15R4_PLAN_SHA256 = (
    "46f4dfd9c44acb3a8b47a7833d0b3882304491cd33952e80538a43ee3e2a3852"
)
FAILED_V15R4_PLAN_BYTES_SHA256 = (
    "4570beccbe1c79a53771116efe6aa547ffe65a39d25508dff0f7a746dad25b6e"
)
FAILED_V15R4_APPROVAL_ID = (
    "controlled-child-cancel-v15r4-c3dcc49c-a4de-40df-964e-20048f8ef993"
)
FAILED_V15R4_BATCH_ID = "cad60f27-a08b-5382-9853-46a74180fc8c"
FAILED_V15R4_BACKEND_COMMIT = "d44ede08d1186159d3d0cf71c001ccc365f760db"
FAILED_V15R4_RUNNER_SHA256 = (
    "766d2d2221d9c3248951ebbe78be2b5d918cad1b488d5dcec87526d2b9f65b85"
)
FAILED_V15R4_CANCEL_IDS = frozenset(
    {
...
R2_USED_IDS = frozenset(
    {
        ...
        *FAILED_PROOF_CANCEL_IDS,
        FAILED_V15R4_BATCH_ID,
        *FAILED_V15R4_CANCEL_IDS,
        "c3dcc49c-a4de-40df-964e-20048f8ef993",
    }
)
...
PLAN_PATH = Path(
    ...
    "coinbase-controlled-spot-child-cancel-v15r5-20260713.plan.json"
)
...
MARKER_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.authority.json"
)
PLACEMENT_LEDGER_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.placements.jsonl"
)
CANCEL_LEDGER_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.cancel-command.jsonl"
)
BACKEND_CLAIM_LOG_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.backend-claims.jsonl"
)
HANDOFF_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.handoff.json"
)
RUNTIME_PATH = REGISTRY_DIR / (
    "test-profile-btc-usdc-selected-child-cancel-v15r5-20260713.runtime.json"
)

FAILED_V15R4_STATE_DIR = (
    ROOT / "artifacts/controlled-root-child-batch-20260713T070801Z-3bf26cda"
)
FAILED_V15R4_REGISTRY_PREFIX = (
    "test-profile-btc-usdc-selected-child-cancel-v15r4-20260713"
)
FAILED_V15R4_ARTIFACT_PATHS: dict[str, Path] = {
    "plan": Path(
        "/home/ec2-user/.local/state/"
        "coinbase-controlled-spot-child-cancel-v15r4-20260713.plan.json"
    ),
    "marker": REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.authority.json",
    "placement_ledger": (
        REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.placements.jsonl"
    ),
    "cancel_ledger": (
        REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.cancel-command.jsonl"
    ),
    "backend_claim_log": (
        REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.backend-claims.jsonl"
    ),
    "runtime_transition": (
        REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.runtime.json"
    ),
    "handoff": REGISTRY_DIR / f"{FAILED_V15R4_REGISTRY_PREFIX}.handoff.json",
    "approvals": FAILED_V15R4_STATE_DIR / "approvals.jsonl",
    "audit": FAILED_V15R4_STATE_DIR / "audit.jsonl",
    "cap_guard": FAILED_V15R4_STATE_DIR / "cap_guard.jsonl",
    "runtime_log": FAILED_V15R4_STATE_DIR / "embedded-runtime.log",
    "runtime_pid": FAILED_V15R4_STATE_DIR / "embedded-runtime.pid",
    "idempotency": FAILED_V15R4_STATE_DIR / "idempotency.jsonl",
    "live_service": FAILED_V15R4_STATE_DIR / "live_service.jsonl",
    "reconciliation": FAILED_V15R4_STATE_DIR / "reconciliation.jsonl",
    "runtime_authority": FAILED_V15R4_STATE_DIR / "runtime-child-authority.json",
    "runtime_authority_used": (
        FAILED_V15R4_STATE_DIR / "runtime-child-authority.used.json"
    ),
    "sentinel": FAILED_V15R4_STATE_DIR / "sdk-boundary-sentinel.json",
}
FAILED_V15R4_ARTIFACT_HASHES: dict[str, str] = {
    "plan": FAILED_V15R4_PLAN_BYTES_SHA256,
    ...
    "runtime_transition": (
        "817910b246598db386ba24aaec688a7f95973f4864283b38ef53314098aabeba"
    ),
    ...
    "runtime_log": (
        "3c7b692f088cc1c9fd161e54aee964f1244d7f50ecd6f938c87472bbd8688e5e"
    ),
    "runtime_pid": (
        "9e97c91ee229d3119877d1a7d80594683529d6761d3f7c75816a567db4862369"
    ),
    "idempotency": (
        "092f3bdd4fc4b8d566693693009ba756ffcf83b1d17195ce955bef87515bea85"
    ),
    "live_service": (
        "840a50fe96b153d5463b44d4b05d5a1aa153bafcc2071fa9be2391c31b8376d8"
    ),
    "reconciliation": (
        "84e5359de97c5b6216c673c1b2574d33b916725d77807c935f30a1101670a6b1"
    ),
    "runtime_authority": (
        "4ab3275561e754ba327c3a291aefcf1f6b51537dd85aabff415c66bb97e05734"
    ),
    "runtime_authority_used": (
        "d99d7c57a3721227e76b0bf8acb0eb81e8f20dc54f7b5ecc4022e532d72c5728"
    ),
    "sentinel": (
        "529b912ab796e73d3ed9ee3f6ba1830cc9f484a82fbf891b76fa5161550cebab"
    ),
}
FAILED_V15R4_ABSENT_ARTIFACT_PATHS: dict[str, Path] = {
    "operator_progress": (
        FAILED_V15R4_STATE_DIR / "v15r4-operator-ui-cancel-handoff.json"
    ),
    "parent_authority_loss": FAILED_V15R4_STATE_DIR / "parent-authority-loss.json",
    "failure_summary": FAILED_V15R4_STATE_DIR / "controlled-batch-failure.json",
    "cleanup_summary": FAILED_V15R4_STATE_DIR / "controlled-batch-cleanup.json",
    "batch_summary": FAILED_V15R4_STATE_DIR / "controlled-batch-summary.json",
}
FAILED_V15R4_RECORD_COUNTS = {
    "approvals": 3,
    "audit": 8,
    "cap_guard": 1,
    "idempotency": 7,
...
FAILED_V15R4_TRANSITION_SHA256 = (
    "c29e7a7a8950c25fb66d4c179afe90bc317b774d885fc6d22cce86020e7808bd"
)
FAILED_V15R4_FAILURE_PAYLOAD_SHA256 = (
    "ad0ba85eb5f532019619c2c7147a238f81256c69dec623de785f295ada33bbf0"
)
FAILED_V15R4_PARENT_PROCESS_ID = 684483
FAILED_V15R4_RUNTIME_PROCESS_ID = 684589
...
V15R5_PLAN_FIELDS = V15R4_PLAN_FIELDS | {"failed_v15r4_execution_binding"}
...
V15R5_RECOVERED_TRANSITION_FIELDS = V15R4_RECOVERED_TRANSITION_FIELDS | {
...
def expected_failed_v15r3_execution_binding() -> dict[str, Any]:
    """Return the exact terminal V15R3 failed-proof lineage retained by V15R5."""
...
def expected_failed_v15r4_execution_binding() -> dict[str, Any]:
    """Return the exact failed service-enable lineage sealed into V15R5."""

    return {
        "schema_version": "1",
        "status": "failed_v15r4_service_enable_bound_no_live_cancel",
        "plan_sha256": FAILED_V15R4_PLAN_SHA256,
        "plan_bytes_sha256": FAILED_V15R4_PLAN_BYTES_SHA256,
        "approval_id": FAILED_V15R4_APPROVAL_ID,
        "batch_id": FAILED_V15R4_BATCH_ID,
        "backend_commit": FAILED_V15R4_BACKEND_COMMIT,
        "runner_sha256": FAILED_V15R4_RUNNER_SHA256,
        "cancel_command_ids": {
        ...
        "artifact_paths": {
            key: str(value) for key, value in FAILED_V15R4_ARTIFACT_PATHS.items()
        },
        "artifact_hashes": dict(FAILED_V15R4_ARTIFACT_HASHES),
        "absent_artifact_paths": {
            key: str(value)
            for key, value in FAILED_V15R4_ABSENT_ARTIFACT_PATHS.items()
        },
        "record_counts": dict(FAILED_V15R4_RECORD_COUNTS),
        "record_hashes": dict(FAILED_V15R4_RECORD_HASHES),
        "transition_sha256": FAILED_V15R4_TRANSITION_SHA256,
        "parent_process_id": FAILED_V15R4_PARENT_PROCESS_ID,
        "runtime_process_id": FAILED_V15R4_RUNTIME_PROCESS_ID,
        "root_sdk_call_count": 0,
        "child_sdk_call_count": 0,
        "cancel_route_call_count": 0,
        ...
        "failure_message": (
            "Enabled live-service decisions require a positive submitted "
            "notional cap."
        ),
        "failure_payload_sha256": FAILED_V15R4_FAILURE_PAYLOAD_SHA256,
...
def load_failed_v15r4_execution_binding() -> dict[str, Any]:
    """Bind the failed service-enable runtime and prove no cancel was posted."""
    ...
    for name, path in FAILED_V15R4_ARTIFACT_PATHS.items():
        _require(
            _file_sha256(
                path,
                f"v15r5_failed_execution_{name}",
                allow_public_read=name in public_read_artifacts,
            )
            == FAILED_V15R4_ARTIFACT_HASHES[name],
            f"v15r5_failed_execution_{name}_hash_mismatch",
        )
    _require(
        all(
            not os.path.lexists(path)
            for path in FAILED_V15R4_ABSENT_ARTIFACT_PATHS.values()
        ),
        "v15r5_failed_execution_absent_artifact_present",
    )

    failed_plan = _json(
        FAILED_V15R4_ARTIFACT_PATHS["plan"],
        "v15r5_failed_execution_plan",
    )
    failed_cancel = dict(failed_plan.get("cancel_command") or {})
    _require(
        set(failed_plan) == V15R4_PLAN_FIELDS
        and failed_plan.get("schema_version") == "22"
        and failed_plan.get("authority_kind")
        == "selected_chain_child_cancel_recovery_v15r4"
        and failed_plan.get("failed_v15r3_execution_binding")
        == expected_failed_v15r3_execution_binding()
        and failed_plan.get("plan_sha256") == FAILED_V15R4_PLAN_SHA256
        and plan_hash(failed_plan) == FAILED_V15R4_PLAN_SHA256
        and failed_plan.get("approval_id") == FAILED_V15R4_APPROVAL_ID
        and failed_plan.get("batch_id") == FAILED_V15R4_BATCH_ID
        and failed_plan.get("backend_commit") == FAILED_V15R4_BACKEND_COMMIT
        and failed_plan.get("runner_sha256") == FAILED_V15R4_RUNNER_SHA256
        and set(cancel_command_ids(failed_plan)) == FAILED_V15R4_CANCEL_IDS
        and failed_cancel.get("semantic_retry_policy")
        ...
        and failed_plan.get("child_placement_authorized") is False
        and failed_plan.get("retry_authorized") is False,
        "v15r5_failed_execution_plan_scope_mismatch",
    )

    marker = _json(
        FAILED_V15R4_ARTIFACT_PATHS["marker"],
        "v15r5_failed_execution_marker",
    )
    _require(
        marker.get("authority")
        == "selected_chain_child_cancel_recovery_v15r4"
        and marker.get("approval_id") == FAILED_V15R4_APPROVAL_ID
        and marker.get("batch_id") == FAILED_V15R4_BATCH_ID
        and marker.get("plan_file")
        == str(FAILED_V15R4_ARTIFACT_PATHS["plan"])
        and marker.get("plan_sha256") == FAILED_V15R4_PLAN_SHA256
        and marker.get("backend_commit") == FAILED_V15R4_BACKEND_COMMIT
        and marker.get("runner_sha256") == FAILED_V15R4_RUNNER_SHA256
        and marker.get("root_client_order_id") == ROOT_CLIENT_ORDER_ID
        and marker.get("child_client_order_id") == CHILD_CLIENT_ORDER_ID
        and marker.get("placement_attempt_maximum") == 0
        and marker.get("root_placement_maximum") == 0
        ...
        and marker.get("cancel_command_maximum") == 1
        and marker.get("placement_ledger_path")
        == str(FAILED_V15R4_ARTIFACT_PATHS["placement_ledger"])
        and marker.get("cancel_ledger_path")
        == str(FAILED_V15R4_ARTIFACT_PATHS["cancel_ledger"])
        and marker.get("backend_claim_log_path")
        == str(FAILED_V15R4_ARTIFACT_PATHS["backend_claim_log"])
        and marker.get("handoff_path")
        == str(FAILED_V15R4_ARTIFACT_PATHS["handoff"])
        and marker.get("process_id") == FAILED_V15R4_PARENT_PROCESS_ID,
        "v15r5_failed_execution_marker_scope_mismatch",
    )

    transition = _json(
        FAILED_V15R4_ARTIFACT_PATHS["runtime_transition"],
        "v15r5_failed_execution_transition",
    )
    transition_child = dict(transition.get("child_readback") or {})
    _require(
        set(transition) == V15R4_RECOVERED_TRANSITION_FIELDS
        and transition.get("schema_version") == "3"
        and transition.get("status") == "v15r3_to_v15r4_no_overlap_proven"
        and transition.get("recovery_status")
        ...
        and transition.get("competitor_pid") is None
        and transition.get("exact_child_open_zero_fill") is True
        and transition_child
        == expected_failed_v15r4_execution_binding()["child_readback"]
        and transition.get("failed_v15r3_execution_binding")
        == expected_failed_v15r3_execution_binding()
        and transition.get("transition_sha256")
        == FAILED_V15R4_TRANSITION_SHA256
        and transition_hash(transition) == FAILED_V15R4_TRANSITION_SHA256,
        "v15r5_failed_execution_transition_scope_mismatch",
    )

    handoff = _json(
        FAILED_V15R4_ARTIFACT_PATHS["handoff"],
        "v15r5_failed_execution_handoff",
    )
    _require(
        handoff.get("authority")
        == "selected_chain_child_cancel_recovery_v15r4"
        and handoff.get("plan_sha256") == FAILED_V15R4_PLAN_SHA256
        and handoff.get("batch_id") == FAILED_V15R4_BATCH_ID
        and handoff.get("root_client_order_id") == ROOT_CLIENT_ORDER_ID
        and handoff.get("child_client_order_id") == CHILD_CLIENT_ORDER_ID
        and handoff.get("actor_id") == ACTOR_ID
        and handoff.get("actor_roles") == ACTOR_ROLES
        and handoff.get("idempotency_key") == failed_cancel.get("idempotency_key")
        and handoff.get("correlation_id") == failed_cancel.get("correlation_id")
        and handoff.get("approval_snapshot_id")
        == failed_cancel.get("approval_snapshot_id")
        and handoff.get("admission_audit_id")
        == expected_failed_v15r4_execution_binding()["proof_ids"][
            "admission_audit_id"
        ]
        and handoff.get("cap_guard_decision_id")
        == failed_cancel.get("cap_guard_decision_id")
        and handoff.get("reconciliation_plan_id")
        == failed_cancel.get("reconciliation_plan_id"),
        "v15r5_failed_execution_handoff_scope_mismatch",
    )

    runtime_authority = _json(
        FAILED_V15R4_ARTIFACT_PATHS["runtime_authority"],
        "v15r5_failed_execution_runtime_authority",
    )
    consumed_authority = _json(
        FAILED_V15R4_ARTIFACT_PATHS["runtime_authority_used"],
        "v15r5_failed_execution_consumed_authority",
    )
    _require(
        runtime_authority.get("plan_sha256") == FAILED_V15R4_PLAN_SHA256
        and runtime_authority.get("batch_id") == FAILED_V15R4_BATCH_ID
        and runtime_authority.get("parent_pid")
        == FAILED_V15R4_PARENT_PROCESS_ID
        and runtime_authority.get("state_dir") == str(FAILED_V15R4_STATE_DIR)
        and runtime_authority.get("global_batch_marker")
        == str(FAILED_V15R4_ARTIFACT_PATHS["marker"])
        and consumed_authority.get("plan_sha256")
        == FAILED_V15R4_PLAN_SHA256
        and consumed_authority.get("batch_id") == FAILED_V15R4_BATCH_ID
        and consumed_authority.get("parent_pid")
        == FAILED_V15R4_PARENT_PROCESS_ID
        and consumed_authority.get("child_pid")
        == FAILED_V15R4_RUNTIME_PROCESS_ID
        and consumed_authority.get("global_batch_marker")
        == str(FAILED_V15R4_ARTIFACT_PATHS["marker"]),
        "v15r5_failed_execution_runtime_authority_scope_mismatch",
    )

    sentinel = _json(
        FAILED_V15R4_ARTIFACT_PATHS["sentinel"],
        "v15r5_failed_execution_sentinel",
    )
    _require(
        sentinel.get("installed") is True
        and sentinel.get("wrapper_identity_proven") is True
        and sentinel.get("phase") == "runtime_exited"
        and sentinel.get("process_id") == FAILED_V15R4_RUNTIME_PROCESS_ID
        and sentinel.get("root_create_order_call_count") == 0
        and sentinel.get("root_create_order_maximum") == 0
        and sentinel.get("root_sdk_inflight") is False
        and sentinel.get("child_place_limit_order_call_count") == 0
        ...
        and sentinel.get("critical_failure") is False
        and sentinel.get("error") is None,
        "v15r5_failed_execution_sentinel_scope_mismatch",
    )
    _require(
        not _jsonl(
            FAILED_V15R4_ARTIFACT_PATHS["placement_ledger"],
            "v15r5_failed_execution_placement_ledger",
        )
        and not _jsonl(
            FAILED_V15R4_ARTIFACT_PATHS["cancel_ledger"],
            "v15r5_failed_execution_cancel_ledger",
        )
        and not _jsonl(
            FAILED_V15R4_ARTIFACT_PATHS["backend_claim_log"],
            "v15r5_failed_execution_backend_claim_log",
        ),
        "v15r5_failed_execution_cancel_or_claim_present",
    )

    rows = {
        name: _jsonl(
            FAILED_V15R4_ARTIFACT_PATHS[name],
            f"v15r5_failed_execution_{name}",
            allow_public_read=True,
        )
        for name in FAILED_V15R4_RECORD_COUNTS
    }
    _require(
        all(
            len(rows[name]) == expected_count
            for name, expected_count in FAILED_V15R4_RECORD_COUNTS.items()
        ),
        "v15r5_failed_execution_record_count_mismatch",
    )
    logical_audit = _record_with_canonical_hash(
        rows["audit"],
        expected_hash=FAILED_V15R4_RECORD_HASHES[
            "logical_cancel_admission_audit"
        ],
        blocker="v15r5_failed_execution_logical_admission_audit_missing",
    )
    admin_audit_idempotency = _record_with_canonical_hash(
        rows["idempotency"],
        expected_hash=FAILED_V15R4_RECORD_HASHES[
            "admin_admission_audit_idempotency"
        ],
        blocker="v15r5_failed_execution_admin_admission_audit_missing",
    )
    enable_rejection = _record_with_canonical_hash(
        rows["audit"],
        expected_hash=FAILED_V15R4_RECORD_HASHES[
            "service_enable_rejection_audit"
        ],
        blocker="v15r5_failed_execution_enable_rejection_missing",
    )
    startup_disabled = _record_with_canonical_hash(
        rows["live_service"],
        expected_hash=FAILED_V15R4_RECORD_HASHES["startup_disabled_service"],
        blocker="v15r5_failed_execution_startup_disable_missing",
    )
    cleanup_disabled = _record_with_canonical_hash(
        rows["live_service"],
        expected_hash=FAILED_V15R4_RECORD_HASHES["cleanup_disabled_service"],
        blocker="v15r5_failed_execution_cleanup_disable_missing",
    )
    cleanup_idempotency = _record_with_canonical_hash(
        rows["idempotency"],
        expected_hash=FAILED_V15R4_RECORD_HASHES[
            "cleanup_disable_idempotency"
        ],
        blocker="v15r5_failed_execution_cleanup_idempotency_missing",
    )
    cleanup_audit = _record_with_canonical_hash(
        rows["audit"],
        expected_hash=FAILED_V15R4_RECORD_HASHES["cleanup_disable_audit"],
        blocker="v15r5_failed_execution_cleanup_audit_missing",
    )
    _require(
        logical_audit.get("endpoint")
        == "POST /api/v1/orders/{root_client_order_id}/fill-follow-up/child-cancel"
        and logical_audit.get("status") == "not_implemented"
        and logical_audit.get("failure_stage") == "admission_audit"
        and logical_audit.get("idempotency_key")
        == failed_cancel.get("idempotency_key")
        and logical_audit.get("live_exchange_submitted") is False
        and logical_audit.get("live_coinbase_orders_ran") is False
        and admin_audit_idempotency.get("endpoint")
        == "POST /api/v1/admin/admission-audits"
        and admin_audit_idempotency.get("status") == "accepted"
        and enable_rejection.get("endpoint")
        == "POST /api/v1/admin/live-execution/service-decisions"
        and enable_rejection.get("status") == "rejected"
        and enable_rejection.get("failure_stage") == "live_service_decision"
        and enable_rejection.get("message")
        == (
            "Enabled live-service decisions require a positive submitted "
            "notional cap."
        )
        and enable_rejection.get("live_exchange_submitted") is False
        and enable_rejection.get("live_coinbase_orders_ran") is False
        and all(
            row.get("status") == "blocked"
            and row.get("requested_service_status") == "live_disabled"
            and row.get("service_enabled") is False
            and row.get("live_coinbase_execution_approved") is False
            and row.get("max_submitted_notional_usdc") == "0"
            and row.get("max_executed_notional_usdc") == "0"
            for row in (startup_disabled, cleanup_disabled)
        )
        and cleanup_idempotency.get("endpoint")
        == "POST /api/v1/admin/live-execution/service-decisions"
        and cleanup_idempotency.get("status") == "accepted"
        and cleanup_audit.get("status") == "accepted"
        and cleanup_audit.get("live_exchange_submitted") is False
        and cleanup_audit.get("live_coinbase_orders_ran") is False,
        "v15r5_failed_execution_record_scope_mismatch",
    )

    approval_snapshot_id = failed_cancel.get("approval_snapshot_id")
    approval_request_id = expected_failed_v15r4_execution_binding()[
        "proof_ids"
    ]["approval_request_id"]
    _require(
        any(
            row.get("approval_request_id") == approval_request_id
            and row.get("status") == "requested"
            for row in rows["approvals"]
        )
        and any(
            row.get("approval_id") == approval_snapshot_id
            and row.get("status") == "approved"
            for row in rows["approvals"]
        )
        and rows["cap_guard"][0].get("decision_id")
        == failed_cancel.get("cap_guard_decision_id")
        and rows["cap_guard"][0].get("status") == "passed"
        and rows["reconciliation"][0].get("plan_id")
        == failed_cancel.get("reconciliation_plan_id")
        and rows["reconciliation"][0].get("status") == "passed",
        "v15r5_failed_execution_proof_chain_mismatch",
    )

    failed_response = {
        "action_class": "local_state_mutation",
        "audit_id": "4939ecc1-c2c5-42fd-babb-34a6ee255414",
        "bff_authority": "forward_only_no_execution",
        "browser_authority": "display_only",
        "correlation_id": "corr-cfa5d57f-9f10-4d50-840b-150c5bd7b0e1",
        "decision": None,
        "idempotency_key": (
            "idem-v15r4-cancel-service-enabled-"
            "e9ee5743-53ef-4b85-866a-d53a1c313525"
        ),
        "live_coinbase_orders_ran": False,
        "live_exchange_submitted": False,
        "message": (
    ...
    _require(
        _canonical_json_sha256(failed_response)
        == FAILED_V15R4_FAILURE_PAYLOAD_SHA256,
        "v15r5_failed_execution_failure_payload_mismatch",
    )

    runtime_log = _text(
        FAILED_V15R4_ARTIFACT_PATHS["runtime_log"],
        "v15r5_failed_execution_runtime_log",
        allow_public_read=True,
    )
    concrete_cancel = (
        f"POST /api/v1/orders/{ROOT_CLIENT_ORDER_ID}/fill-follow-up/child-cancel"
    ...
    readiness = (
        f"GET /api/v1/orders/{ROOT_CLIENT_ORDER_ID}/fill-follow-up/"
        f"child-cancel/readiness?controlled_plan_sha256="
        f"{FAILED_V15R4_PLAN_SHA256}"
    )
    _require(
        runtime_log.count(concrete_cancel) == 0
        and runtime_log.count(readiness) == 1
        and runtime_log.count(
            'POST /api/v1/admin/admission-audits HTTP/1.1" 200 OK'
        )
        == 1
        and runtime_log.count(
            'POST /api/v1/admin/live-execution/service-decisions HTTP/1.1" '
            "400 Bad Request"
        )
        == 1
        and "Received SIGTERM; initiating graceful shutdown" in runtime_log
        and "Application shutdown complete." in runtime_log,
        "v15r5_failed_execution_runtime_log_scope_mismatch",
    )
    _require(
        _process_id_absent(FAILED_V15R4_PARENT_PROCESS_ID)
        and _process_id_absent(FAILED_V15R4_RUNTIME_PROCESS_ID),
        "v15r5_failed_execution_process_present",
    )
    base.require_runtime_exclusivity(require_port_free=True)
    return expected_failed_v15r4_execution_binding()


def load_current_v15r3_source_binding(
) -> tuple[dict[str, Any], dict[str, Any]]:
    """Load completed predecessors and both failed cancel-only runtimes."""
    ...
    completed["failed_v15r4_execution_binding"] = (
        load_failed_v15r4_execution_binding()
    )
...
def build_v15r3_plan(
    ...
    *,
    ...
    failed_v15r4_execution_binding: Mapping[str, Any] | None = None,
    now: datetime | None = None,
    approval_id: str | None = None,
) -> dict[str, Any]:
    created_at = (now or datetime.now(timezone.utc)).astimezone(timezone.utc)
    approval = approval_id or f"controlled-child-cancel-v15r5-{uuid4()}"
    _require(
        approval.startswith("controlled-child-cancel-v15r5-"),
        "v15r3_approval_namespace_invalid",
    )
    UUID(approval.removeprefix("controlled-child-cancel-v15r5-"))
    exact_runner = runner_sha256()
    commit = backend_commit()
    batch_id = str(
        uuid5(
            NAMESPACE_URL,
            f"coinbase://selected-child-cancel-v15r5/{commit}/{exact_runner}/{approval}",
        )
    )
    ...
    failed_v15r4_binding = dict(
        failed_v15r4_execution_binding
        or expected_failed_v15r4_execution_binding()
    )
    _require(
        failed_v15r4_binding == expected_failed_v15r4_execution_binding(),
        "v15r5_failed_execution_binding_mismatch",
    )
    cancel = {
    ...
    plan: dict[str, Any] = {
        ...
        "failed_v15r4_execution_binding": failed_v15r4_binding,
...
def validate_v15r3_plan(
    ...
    _require(set(plan) == V15R5_PLAN_FIELDS, "v15r3_plan_fields_mismatch")
    ...
    _require(
        ...
        == expected_failed_v15r4_execution_binding(),
        "v15r5_failed_execution_binding_mismatch",
    )
    ...
    _require(
        ...
        and plan.get("failed_v15r4_execution_binding")
        == completed_shutdown.get("failed_v15r4_execution_binding"),
...
def bind_completed_v15r2_shutdown(
    ...
    *,
    ...
    failed_v15r4 = dict(completed["failed_v15r4_execution_binding"])
    proof: dict[str, Any] = {
        "schema_version": "4",
        "status": "v15r4_to_v15r5_no_overlap_proven",
        "recovery_status": "failed_v15r4_service_enable_bound_no_live_cancel",
        "transition_mode": (
            "bind_completed_predecessor_shutdowns_no_signals"
        ),
        "controlled_plan_sha256": confirmed_plan_sha256,
        "failed_plan_sha256": failed_v15r4["plan_sha256"],
        "failed_plan_bytes_sha256": failed_v15r4["plan_bytes_sha256"],
        "failed_batch_id": failed_v15r4["batch_id"],
        "failed_backend_commit": failed_v15r4["backend_commit"],
        "failed_runner_sha256": failed_v15r4["runner_sha256"],
        "r2_plan_sha256": R2_PLAN_SHA256,
        ...
        "failed_v15r4_execution_binding": failed_v15r4,
        "admin_port_8787_free": True,
        "competitor_pid": None,
        "exact_child_open_zero_fill": (
...
def _validate_frozen_plan_after_transition(
    ...
    *,
    ...
    _require(
        set(proof) == V15R5_RECOVERED_TRANSITION_FIELDS
        and proof.get("schema_version") == "4"
        and proof.get("status") == "v15r4_to_v15r5_no_overlap_proven"
        ...
        and proof.get("failed_plan_sha256") == FAILED_V15R4_PLAN_SHA256
        and proof.get("failed_plan_bytes_sha256")
        == FAILED_V15R4_PLAN_BYTES_SHA256
        and proof.get("failed_batch_id") == FAILED_V15R4_BATCH_ID
        and proof.get("failed_backend_commit") == FAILED_V15R4_BACKEND_COMMIT
        and proof.get("failed_runner_sha256") == FAILED_V15R4_RUNNER_SHA256
        ...
        == plan.get("failed_v15r3_execution_binding")
        == expected_failed_v15r3_execution_binding()
        and proof.get("failed_v15r4_execution_binding")
        == plan.get("failed_v15r4_execution_binding")
        == expected_failed_v15r4_execution_binding()
...
def set_v15r3_cancel_only_service(
    ...
    body = {
        "decision_id": f"v15r5-cancel-only-{label}-{uuid4()}",
        ...
        "decision_reason": (
            ...
            if enabled
            else "Disable V15R5 cancel-only service at transition or closeout."
        ),
    ...
    _, response, _ = runtime.request(
        ...
        headers=runtime.headers(
            idempotency_key=f"idem-v15r5-cancel-service-{label}-{uuid4()}",
            operator_intent=f"record_v15r5_cancel_service_{label}",
...
def execute_v15r3_plan(
    *, plan_path: Path, confirmed_plan_sha256: str
    ...
    try:
        ...
        progress_path = runtime.state_dir / "v15r5-operator-ui-cancel-handoff.json"
    ...
    *,
    ...
    plan = build_v15r3_plan(
        ...
        failed_v15r4_execution_binding=dict(
            completed_shutdown["failed_v15r4_execution_binding"]
        ),
        now=now,
    )
    ...
    return {
        ...
        "failed_v15r4_execution_bound": True,
...
def main(argv: list[str] | None = None) -> int:
    ...
    mode.add_argument("--prepare-v15r5-plan", action="store_true")
    mode.add_argument("--execute-v15r5-plan", action="store_true")
    parser.add_argument("--plan-file")
    parser.add_argument("--confirm-plan-sha256")
    args = parser.parse_args(argv)
    if args.prepare_v15r5_plan:
