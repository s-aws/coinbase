...
Usage:
    python tools/diagnostics/cli_parent_child_orders.py
    python tools/diagnostics/cli_parent_child_orders.py --parent ORDER_ID
    python tools/diagnostics/cli_parent_child_orders.py --status FILLED
    python tools/diagnostics/cli_parent_child_orders.py --help
