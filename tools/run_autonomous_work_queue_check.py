...
APPROVED_PHASE_RANGE = "6841-6860"
APPROVED_PHASES = tuple(range(6841, 6861))
PREVIOUS_COMPLETED_PHASE_RANGE = "6821-6840"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6841-6860` evidence adds disabled futures request payload validation record collateral semantics while completed M57 `6821-6840` carries forward disabled futures request payload validation record margin semantics.",
