...
APPROVED_PHASE_RANGE = "6741-6760"
APPROVED_PHASES = tuple(range(6741, 6761))
PREVIOUS_COMPLETED_PHASE_RANGE = "6721-6740"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6741-6760` evidence adds disabled futures request payload validation record semantic artifact definition review output acceptance evidence while completed M57 `6721-6740` carries forward disabled futures request payload validation record semantic artifact definition review output evidence.",
