...
APPROVED_PHASE_RANGE = "7021-7040"
APPROVED_PHASES = tuple(range(7021, 7041))
PREVIOUS_COMPLETED_PHASE_RANGE = "7001-7020"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `7021-7040` evidence adds futures request payload validation record execution-eligibility resolution-plan evidence while completed M57 `7001-7020` carries forward futures request payload validation record execution-eligibility semantic closure evidence.",
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "futures request payload validation record execution-eligibility resolution-plan display",
        ...
        "blocker_resolved",
        "resolution plan presence is not blocker resolution",
        "no validators",
