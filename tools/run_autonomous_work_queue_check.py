...
APPROVED_PHASE_RANGE = "6921-6940"
APPROVED_PHASES = tuple(range(6921, 6941))
PREVIOUS_COMPLETED_PHASE_RANGE = "6901-6920"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6921-6940` evidence adds disabled futures request payload validation record funding semantics while completed M57 `6901-6920` carries forward disabled futures request payload validation record close-only semantics.",
