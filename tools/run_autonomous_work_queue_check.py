...
APPROVED_PHASE_RANGE = "7181-7200"
APPROVED_PHASES = tuple(range(7181, 7201))
PREVIOUS_COMPLETED_PHASE_RANGE = "7161-7180"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `7181-7200` evidence adds futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency evidence while completed M57 `7161-7180` carries forward futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation evidence.",
