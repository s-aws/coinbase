...
APPROVED_PHASE_RANGE = "7001-7020"
APPROVED_PHASES = tuple(range(7001, 7021))
PREVIOUS_COMPLETED_PHASE_RANGE = "6981-7000"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `7001-7020` evidence adds futures request payload validation record execution-eligibility semantic closure evidence while completed M57 `6981-7000` carries forward disabled futures request payload validation record reconciliation semantics.",
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "futures request payload validation record execution-eligibility semantic closure evidence",
        "futures request payload validation record execution-eligibility semantic closure display",
        "futures request payload validation record reconciliation semantics",
        ...
        "semantic contract presence is not runtime acceptance",
        "no validators",
