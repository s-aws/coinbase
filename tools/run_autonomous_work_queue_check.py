...
APPROVED_PHASE_RANGE = "6881-6900"
APPROVED_PHASES = tuple(range(6881, 6901))
PREVIOUS_COMPLETED_PHASE_RANGE = "6861-6880"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6881-6900` evidence adds disabled futures request payload validation record reduce-only semantics while completed M57 `6861-6880` carries forward disabled futures request payload validation record liquidation semantics.",
