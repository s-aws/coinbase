...
APPROVED_PHASE_RANGE = "6861-6880"
APPROVED_PHASES = tuple(range(6861, 6881))
PREVIOUS_COMPLETED_PHASE_RANGE = "6841-6860"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6861-6880` evidence adds disabled futures request payload validation record liquidation semantics while completed M57 `6841-6860` carries forward disabled futures request payload validation record collateral semantics.",
