...
APPROVED_PHASE_RANGE = "7041-7060"
APPROVED_PHASES = tuple(range(7041, 7061))
PREVIOUS_COMPLETED_PHASE_RANGE = "7021-7040"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `7041-7060` evidence adds futures request payload validation record execution-eligibility resolution-plan step evidence while completed M57 `7021-7040` carries forward futures request payload validation record execution-eligibility resolution-plan evidence.",
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "blocker_resolved",
        "resolution plan step presence is not blocker resolution",
        "no validators",
