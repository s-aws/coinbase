...
APPROVED_PHASE_RANGE = "7681-7700"
APPROVED_PHASES = tuple(range(7681, 7701))
PREVIOUS_COMPLETED_PHASE_RANGE = "7661-7680"
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim-trace clearance plan display",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim trace evidence",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim trace display",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim-trace clearance plan evidence",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim-trace clearance plan display",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim trace evidence",
        "futures request payload validation record execution-eligibility resolution-plan step review input store record-validation remediation dependency work-item claim trace display",
        ...
        "resolution_plan_step_review_input_required",
        ...
        "no claim-trace clearance",
        "no clearance plan creation",
        "no validators",
        "no command admission",
        "no Coinbase execution",
        "no reconciliation execution",
        "no futures/order/exchange mutation",
