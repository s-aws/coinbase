...
APPROVED_PHASE_RANGE = "6961-6980"
APPROVED_PHASES = tuple(range(6961, 6981))
PREVIOUS_COMPLETED_PHASE_RANGE = "6941-6960"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6961-6980` evidence adds disabled futures request payload validation record cancel semantics while completed M57 `6941-6960` carries forward disabled futures request payload validation record order semantics.",
