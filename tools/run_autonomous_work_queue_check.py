...
APPROVED_PHASE_RANGE = "6941-6960"
APPROVED_PHASES = tuple(range(6941, 6961))
PREVIOUS_COMPLETED_PHASE_RANGE = "6921-6940"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6941-6960` evidence adds disabled futures request payload validation record order semantics while completed M57 `6921-6940` carries forward disabled futures request payload validation record funding semantics.",
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "futures request payload validation record margin semantics",
        "futures request payload validation record collateral semantics",
        "futures request payload validation record reduce-only semantics",
        "futures request payload validation record close-only semantics",
        "futures request payload validation record funding semantics",
        "futures request payload validation record order semantics",
        "futures request payload validation record liquidation semantics",
        "futures request payload validation record replay guard evidence",
        "futures request payload validation record semantic artifact runtime evidence acceptance",
        ...
        "funding_semantics_ref",
        "funding_semantics_contract_ref",
        "order_semantics_ref",
        ...
        "runtime_evidence_satisfies_validation_record",
        "validation_record_contract_ready",
        "validation_record_store_ready",
        "validation_record_writer_enabled",
        "validation_record_replay_guard_ready",
        "runtime_evidence_satisfies_validation_record_schema",
        "runtime_evidence_satisfies_validation_record_replay_guard",
        ...
        "collateral_semantics_contract_available",
        "collateral_semantics_contract_ready",
        "liquidation_semantics_contract_available",
        "liquidation_semantics_contract_ready",
        ...
        "funding_semantics_contract_available",
        "funding_semantics_contract_ready",
        "order_semantics_contract_available",
        ...
        "collateral_currency_bound",
        "collateral_requirement_bound",
        "collateral_source_bound",
        "liquidation_buffer_bound",
        "liquidation_price_bound",
        "liquidation_distance_bound",
        ...
        "runtime_collateral_evidence_observed",
        ...
        "runtime_order_evidence_observed",
        "runtime_evidence_satisfies_position_semantics",
        "runtime_evidence_satisfies_margin_semantics",
        "runtime_evidence_satisfies_collateral_semantics",
        "runtime_evidence_satisfies_liquidation_semantics",
        "runtime_evidence_satisfies_reduce_only_semantics",
        "runtime_evidence_satisfies_close_only_semantics",
        "runtime_evidence_satisfies_funding_semantics",
        "runtime_evidence_satisfies_order_semantics",
        "validation_record_position_semantics_ready",
        "validation_record_margin_semantics_ready",
        "validation_record_collateral_semantics_ready",
        "validation_record_liquidation_semantics_ready",
        "validation_record_reduce_only_semantics_ready",
        "validation_record_close_only_semantics_ready",
        "validation_record_funding_semantics_ready",
        "validation_record_order_semantics_ready",
    ...
    stale = [
        ...
        "Active `6241-6260`",
        "current active range is `6261-6280`",
        "Active autonomous range: `6261-6280`",
        "complete active phases `6261-6280`",
        "Active `6261-6280`",
        "current active range is `6301-6320`",
        ...
        "complete active phases `6361-6380`",
        "current active range is `6461-6480`",
        "Active autonomous range: `6461-6480`",
        "complete active phases `6461-6480`",
        "Active `6461-6480`",
    ]
...
def _check_contextless_review_log_docs() -> QueueCheck:
    ...
    required = [
        ...
        "funding_semantics_contract_ready=false",
        "order_semantics_contract_available=false",
        "order_semantics_contract_ready=false",
        ...
        "funding_rate_bound=false",
        "funding_fee_bound=false",
        "funding_interval_bound=false",
        "funding_cost_bound=false",
        "order_identity_bound=false",
        "order_side_bound=false",
        "order_size_bound=false",
        "order_price_bound=false",
        "order_type_bound=false",
        ...
        "runtime_funding_evidence_observed=false",
