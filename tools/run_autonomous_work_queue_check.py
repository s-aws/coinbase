...
APPROVED_PHASE_RANGE = "6981-7000"
APPROVED_PHASES = tuple(range(6981, 7001))
PREVIOUS_COMPLETED_PHASE_RANGE = "6961-6980"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6981-7000` evidence adds disabled futures request payload validation record reconciliation semantics while completed M57 `6961-6980` carries forward disabled futures request payload validation record cancel semantics.",
...
def _check_agent_state_docs() -> QueueCheck:
    required = [
        ...
        "futures request payload validation record cancel semantics",
...
def _check_contextless_review_log_docs() -> QueueCheck:
    ...
    required = [
        ...
        "cancel_semantics_contract_ready=false",
