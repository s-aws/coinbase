...
APPROVED_PHASE_RANGE = "7061-7080"
APPROVED_PHASES = tuple(range(7061, 7081))
PREVIOUS_COMPLETED_PHASE_RANGE = "7041-7060"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `7061-7080` evidence adds futures request payload validation record execution-eligibility resolution-plan step review evidence while completed M57 `7041-7060` carries forward futures request payload validation record execution-eligibility resolution-plan step evidence.",
