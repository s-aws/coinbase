...
APPROVED_PHASE_RANGE = "6821-6840"
APPROVED_PHASES = tuple(range(6821, 6841))
PREVIOUS_COMPLETED_PHASE_RANGE = "6801-6820"
...
def _check_example_phase_range_docs() -> QueueCheck:
    required_by_path = {
        ...
        FUTURES_PERPETUALS_README: [
            ...
            "Active M57 `6821-6840` evidence adds disabled futures request payload validation record margin semantics while completed M57 `6801-6820` carries forward disabled futures request payload validation record position semantics.",
