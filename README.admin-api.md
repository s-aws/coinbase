...
availability claims back to those work items. Active phases 3841-3860 add
blocked producer-route requirements and a summary mapping those claim traces
to the missing backend route contract evidence. These layers do not register
routes, bind route inventory, construct adapters, write or accept evidence,
