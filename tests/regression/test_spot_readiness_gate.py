...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6121, 6141))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Disabled Adapter-Decision-Record Contract Evidence - "
            "Phases 6121-6140"
        )
    ...
    assert summary["approved_phase_range"] == "6121-6140"
