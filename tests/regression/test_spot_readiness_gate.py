...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6221, 6241))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Disabled Post-Exchange-Submission "
            "Command Enablement Blocker Summary Evidence - Phases 6221-6240"
        )
    ...
    assert summary["approved_phase_range"] == "6221-6240"
