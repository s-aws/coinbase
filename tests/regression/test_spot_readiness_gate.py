...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6741, 6761))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            ...
            "Semantic Artifact Definition Review Output Acceptance Evidence - Phases 6741-6760"
        )
        assert (
    ...
    assert summary["approved_phase_range"] == "6741-6760"
