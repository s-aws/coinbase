...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6181, 6201))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Disabled Coinbase Exchange-Submission Contract Evidence - "
            "Phases 6181-6200"
        )
    ...
    assert summary["approved_phase_range"] == "6181-6200"
