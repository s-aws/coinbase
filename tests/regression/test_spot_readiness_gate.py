...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6361, 6381))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Request Payload Contract Registry Evidence "
            "- Phases 6361-6380"
        )
    ...
    assert summary["approved_phase_range"] == "6361-6380"
