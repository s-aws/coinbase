...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6301, 6321))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Proof Route/Writer Contract Registry "
            "Evidence - Phases 6301-6320"
        )
    ...
    assert summary["approved_phase_range"] == "6301-6320"
