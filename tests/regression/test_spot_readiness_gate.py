...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6261, 6281))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Command Enablement Sequence "
            "Command-Trace Evidence - Phases 6261-6280"
        )
    ...
    assert summary["approved_phase_range"] == "6261-6280"
