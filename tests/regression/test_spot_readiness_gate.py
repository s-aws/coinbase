...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6621, 6641))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            ...
            "Execution Eligibility Blocker Evidence - Phases 6621-6640"
        )
        assert (
    ...
    assert summary["approved_phase_range"] == "6621-6640"
