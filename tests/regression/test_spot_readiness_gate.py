...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6101, 6121))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Disabled Adapter-Decision Contract Evidence - "
            "Phases 6101-6120"
        )
    ...
    assert summary["approved_phase_range"] == "6101-6120"
