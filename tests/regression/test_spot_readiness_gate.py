...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6761, 6781))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            ...
            "Semantic Artifact Runtime Evidence Binding - Phases 6761-6780"
        )
        assert (
    ...
    assert summary["approved_phase_range"] == "6761-6780"
