...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6281, 6301))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Reconciliation Command-Service Parity "
            "Evidence - Phases 6281-6300"
        )
    ...
    assert summary["approved_phase_range"] == "6281-6300"
