...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6241, 6261))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            ...
            "Command Enablement Sequence Evidence - Phases 6241-6260"
        )
    ...
    assert summary["approved_phase_range"] == "6241-6260"
