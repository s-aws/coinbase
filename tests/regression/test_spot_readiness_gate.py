...
def test_autonomous_work_queue_check_covers_approved_20_phase_batch():
    ...
    assert AUTONOMOUS_APPROVED_PHASES == tuple(range(6401, 6421))
    ...
    if failed_checks:
        ...
        assert review_evidence["first_review_heading"] == (
            "## M57 Futures/Perpetual Request Payload Validator Contract Registry Evidence "
            "- Phases 6401-6420"
        )
    ...
    assert summary["approved_phase_range"] == "6401-6420"
