...
SPOT_ELIGIBILITY_MINIMUM_SIZE_GOAL_KEYS = frozenset(
    {
        SPOT_ELIGIBILITY_MINIMUM_SIZE_V7_GOAL_KEY,
        SPOT_ELIGIBILITY_MINIMUM_SIZE_V8_GOAL_KEY,
        SPOT_ELIGIBILITY_MINIMUM_SIZE_V9_GOAL_KEY,
...
SPOT_ELIGIBILITY_TRANSPORT_GOAL_KEYS = frozenset(
    {
        SPOT_ELIGIBILITY_TRANSPORT_V13_GOAL_KEY,
        SPOT_ELIGIBILITY_TRANSPORT_V14_GOAL_KEY,
        SPOT_ELIGIBILITY_TRANSPORT_V15_GOAL_KEY,
...
SPOT_ELIGIBILITY_ATOMIC_MARKET_SNAPSHOT_GOAL_KEYS = frozenset(
    {
        SPOT_ELIGIBILITY_ATOMIC_MARKET_SNAPSHOT_V10_GOAL_KEY,
        SPOT_ELIGIBILITY_ATOMIC_MARKET_SNAPSHOT_V11_GOAL_KEY,
        SPOT_ELIGIBILITY_ATOMIC_MARKET_SNAPSHOT_V12_GOAL_KEY,
        *SPOT_ELIGIBILITY_TRANSPORT_GOAL_KEYS,
    }
)
SPOT_ELIGIBILITY_POST_ONLY_GOAL_KEYS = frozenset(
    {
