...
AUTONOMOUS_APPROVED_PHASE_RANGE = "2681-2700"
...
class AdminApiReadService:
    ...
    def build_stealth_command_suite(self) -> StealthCommandSuiteResponse:
        ...
        cancel_replace_documentation_refs = {
            AdminApiMutationFamilyType.STEALTH_CANCEL: [
                "README.stealth-command-suite.md",
                "docs/agents/INVARIANTS.md",
                "docs/COMMAND_WORKFLOWS.md",
        ...
        for mutation_family, required_contracts in cancel_replace_contracts_by_family.items():
            metadata = command_metadata[mutation_family]
            inventory_item = inventory_by_surface[str(metadata["surface"])]
            method, route = _surface_method_and_path(inventory_item.surface)
            cancel_replace_boundaries.append(
                StealthCommandSuiteCancelReplaceBoundaryItem(
                    mutation_family=mutation_family,
                    route=route,
                    method=method,
                    ...
                    canonical_behavior_path=list(
                        cancel_replace_behavior_paths[mutation_family]
                    ),
                    backend_owned=True,
                    route_bound=True,
                    browser_authority="display_only",
                    ...
                    exchange_state_mutated=False,
                    documentation_refs=list(
                        cancel_replace_documentation_refs[mutation_family]
                    ),
                    detail=cancel_replace_details[mutation_family],
                )
            )
