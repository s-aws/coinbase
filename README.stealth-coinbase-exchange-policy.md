...
```bash
python -m pytest tests/regression/test_admin_api_contract.py::test_admin_api_stealth_coinbase_exchange_policy_proof_is_no_live_and_path_keyed -q --tb=short
```
