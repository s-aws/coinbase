...
The active 5881-5900 range adds explicit M57 futures/perpetual semantic
contract validation gate evidence to `GET /api/v1/futures/command-suite`.
...
evidence do not register validators, make validation gates ready, make
semantic contract definitions ready, register semantic contracts, satisfy risk
