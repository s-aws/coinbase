...
Current active Admin API examples use `"approved_phase_range": "8021-8040"`.
...
active release-control range is `"approved_phase_range": "8021-8040"`.
...
```json
{
  ...
  "lifecycle_supported_read_count": 4,
  "lifecycle_not_modeled_count": 1,
  "lifecycle_unsupported_count": 1,
  "module_registry_count": 8,
  "module_action_posture_count": 8,
  "functionality_inventory_count": 26,
  "backend_supported_workflow_count": 26,
  "admin_exposed_workflow_count": 24,
  "command_workflow_count": 18,
