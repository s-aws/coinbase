...
- Latest completed autonomous range: `3241-3260` under M55.
- Active autonomous range: `3261-3280` under M55.
- M49 approval lifecycle, M50 cap/guard records, M51 admission audits, and
  ...
  The active 3261-3280 range adds backend-derived forbidden execution claim
  ...
  execution, browser, or BFF authority.
