...
- Active autonomous range: `2161-2180`.
- M49 approval lifecycle, M50 cap/guard records, M51 admission audits, and
  ...
  new endpoint, or grant browser/BFF reveal authority. The active 2161-2180
  range adds no-live reveal reconciliation audit evidence to that same detail
  ...
  endpoint, or grant browser/BFF reveal authority.
