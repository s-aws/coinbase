...
- Latest completed autonomous range: `3181-3200` under M55.
- Active autonomous range: `3201-3220` under M55.
- M49 approval lifecycle, M50 cap/guard records, M51 admission audits, and
  ...
  dependency evidence. The active 3201-3220 range adds backend-derived
