...
- Latest completed autonomous range: `3121-3140` under M55.
- Active autonomous range: `3141-3160` under M55.
- M49 approval lifecycle, M50 cap/guard records, M51 admission audits, and
  ...
  display-only authority. The active 3141-3160 range adds backend-owned
  decision-resolution handoff classification over those summaries while
  preserving blocked/no-live display-only authority.
