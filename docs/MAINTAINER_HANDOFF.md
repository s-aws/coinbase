...
- Latest completed autonomous range: `3701-3720` under M55.
- Active autonomous range: `3721-3740` under M55.
- Completed 3421-3440 work consumes backend-owned stealth state-mutation
  ...
  no-live authority. Active 3721-3740 work adds blocked producer-readiness rows
  ...
  no-acceptance, false satisfaction, and no-live authority. Those fields remain
  evidence only and do not satisfy artifacts.
