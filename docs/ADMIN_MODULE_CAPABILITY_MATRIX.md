...
Current futures/perpetual M57 scope: `7541-7560` adds futures request payload
...
record-validation remediation dependency work-item claim-trace clearance-step
review input store record-validation check output schema field-type evidence. The current
...
field-type declaration, field-name declaration, field declaration, schema declaration, source-ref
