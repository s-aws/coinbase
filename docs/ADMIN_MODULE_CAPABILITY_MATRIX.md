...
Current futures/perpetual M57 scope: `7521-7540` adds futures request payload
...
record-validation remediation dependency work-item claim-trace clearance-step
review input store record-validation check output schema field-name evidence. The current
...
field-name declaration, field declaration, schema declaration, source-ref
declaration, contextless review passage, validation-check output schema
field-type readiness, command admission, Coinbase execution, reconciliation
execution, browser/BFF authority, or spot-rule authority.

Completed futures/perpetual M57 scope: `7501-7520` adds futures request payload
validation record execution-eligibility resolution-plan step review input store
record-validation remediation dependency work-item claim-trace clearance-step
review input store record-validation check output schema field-name evidence on top
of completed `7481-7500` futures request payload validation record
execution-eligibility resolution-plan step review input store
record-validation remediation dependency work-item claim-trace clearance-step
review input store record-validation check output schema field evidence. The completed
rows are backend-owned, display-only, no-live, and do not treat
validation-check output-schema-field-name presence as field-name declaration,
field declaration, schema declaration, source-ref declaration, contextless
review passage, validation-check output schema field-name readiness, command
