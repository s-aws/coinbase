...
and exact-child Cancel. Six-category preparation and eligibility share `0/10`
durable no-retry cycles. Preview/Create/Cancel calls are `0/0/0`; all
allowances remain unconsumed after readiness passed. See
