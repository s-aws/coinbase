...
blocker is cancel acknowledgement/live-service handling; SELL should remain on
the same manual-order path and needs operator-facing validation evidence before
Release 0.1 closeout.
