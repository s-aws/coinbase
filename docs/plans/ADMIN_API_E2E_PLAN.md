...
- Link placement semantic guards to product-scope, account-risk, approval,
  cap/guard, admission-audit, reconciliation-plan, and live-boundary evidence
  routes and missing refs.
