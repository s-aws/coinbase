...
- Approved phase range: **5121-5140**.
- Range status: active under M55 - Stealth Full Admin Command Suite.
- Previous completed range: `5101-5120`.
...
Batch label: Stealth Create Candidate Pre-Execution Contract Review.
...
exchange-facing blockers. The work must turn that selection into exact
...
- Define the backend-owned create payload fields and validation boundaries
  required before a future manager call can exist. This phase must not accept
  browser-derived validation as execution authority.
