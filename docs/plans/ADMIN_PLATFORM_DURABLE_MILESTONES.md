...
| M55 - Stealth Full Admin Command Suite | In Progress; active range 8001-8020 | Complete stealth create/cancel/reveal/move/reprice/recovery workflows while preserving exchange-reality invariants and mutation locks. |
...
| M61 - Release 0.1 Private Operator Admin MVP | In Progress; active range 8001-8020 | Release a usable private operator admin product that can manage backend-supported workflows while explicit gaps appear as `unsupported` or `not_modeled`. |
