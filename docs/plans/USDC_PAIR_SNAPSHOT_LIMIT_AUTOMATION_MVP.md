...
product-row candidate/cap-guard record refs/live-readiness record/source refs,
and no queued product-row blockers, plus a non-empty selected-product recovery ref
...
associations, rejects stale queued product-row cap-guard record evidence,
