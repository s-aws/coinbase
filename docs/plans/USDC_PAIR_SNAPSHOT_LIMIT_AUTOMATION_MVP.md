...
- M58 Phase F no-live allowlist-readiness and run-state evidence for explicit
  ...
  store record, latest live-readiness price-freshness and price-distance
  statuses still passed, ready aggregate parent
...
price-freshness or price-distance status, rejects stale selected-product
