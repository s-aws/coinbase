...
content refs, and no queued product-row blockers, plus a non-empty selected-product recovery ref
...
associations or readiness content/freshness evidence, rejects stale queued
