...
- Backend-only Admin live-read smoke tools use the default AWS Secrets Manager
  secret id `coinbase` when direct environment credentials are absent. Override
