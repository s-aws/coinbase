"""Calculator bridge providing order calculation utilities.

Wraps OrderCalculator to provide a clean interface for calculating follow-up
order prices, sizes, fees, and position impacts.
...
class CalculatorBridge:
    """Adapter bridge wrapping OrderCalculator for OrderEngine.
