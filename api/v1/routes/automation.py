...
USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_RATE_LIMIT_BLOCKED_STATUS = "blocked_no_live"
...
USDC_PAIR_SNAPSHOT_SCHEDULER_WALLET_LEDGER_BLOCKED_STATUS = "blocked_no_live"
...
USDC_PAIR_SNAPSHOT_SCHEDULER_RATE_LIMIT_BLOCKED_STATUS = "blocked_no_live"
...
USDC_PAIR_SNAPSHOT_SCHEDULER_RUNTIME_CONTROL_BLOCKED_STATUS = "blocked_no_live"
...
def _allowlist_run_state_item_from_record(
    ...
    return UsdcPairSnapshotAllowlistRunStateItem(
        ...
        runtime_fanout_price_freshness_status=(
            record.runtime_fanout_price_freshness_status
        ),
        runtime_fanout_price_freshness_ref=(
            record.runtime_fanout_price_freshness_ref
        ),
        ...
        runtime_fanout_admission_audit_status=(
            record.runtime_fanout_admission_audit_status
        ),
        runtime_fanout_admission_audit_ref=(
            record.runtime_fanout_admission_audit_ref
        ),
        ...
        runtime_fanout_retry_recovery_ref=(
            record.runtime_fanout_retry_recovery_ref
        ),
        ...
        scheduler_wallet_ledger_status=record.scheduler_wallet_ledger_status,
        ...
        scheduler_rate_limit_status=record.scheduler_rate_limit_status,
        scheduler_rate_limit_ref=record.scheduler_rate_limit_ref,
        scheduler_rate_limit_blockers=record.scheduler_rate_limit_blockers,
        scheduler_runtime_control_status=record.scheduler_runtime_control_status,
        scheduler_runtime_control_ref=record.scheduler_runtime_control_ref,
...
def _usdc_pair_allowlist_run_state_live_fanout_submit_blockers(
    *,
    ...
    extend_if_not_ready(
        status_value=run_state.scheduler_standing_cap_status,
        ref_value=run_state.scheduler_standing_cap_ref,
        blocker_values=list(run_state.scheduler_standing_cap_blockers),
        fallback="scheduler_standing_cap_not_ready",
        ref_missing="scheduler_standing_cap_ref_missing",
        blockers_present="scheduler_standing_cap_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_wallet_ledger_status,
        ref_value=run_state.scheduler_wallet_ledger_ref,
        blocker_values=list(run_state.scheduler_wallet_ledger_blockers),
        fallback="scheduler_wallet_ledger_not_ready",
        ref_missing="scheduler_wallet_ledger_ref_missing",
        blockers_present="scheduler_wallet_ledger_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_release_review_status,
        ref_value=run_state.scheduler_release_review_ref,
        blocker_values=list(run_state.scheduler_release_review_blockers),
        fallback="scheduler_release_review_not_ready",
        ref_missing="scheduler_release_review_ref_missing",
        blockers_present="scheduler_release_review_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_worker_status,
        ref_value=run_state.scheduler_worker_ref,
        blocker_values=list(run_state.scheduler_worker_blockers),
        fallback="scheduler_worker_not_ready",
        ref_missing="scheduler_worker_ref_missing",
        blockers_present="scheduler_worker_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_rate_limit_status,
        ref_value=run_state.scheduler_rate_limit_ref,
        blocker_values=list(run_state.scheduler_rate_limit_blockers),
        fallback="scheduler_rate_limit_not_ready",
        ref_missing="scheduler_rate_limit_ref_missing",
        blockers_present="scheduler_rate_limit_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_runtime_control_status,
        ref_value=run_state.scheduler_runtime_control_ref,
        blocker_values=list(run_state.scheduler_runtime_control_blockers),
        fallback="scheduler_runtime_control_not_ready",
        ref_missing="scheduler_runtime_control_ref_missing",
        blockers_present="scheduler_runtime_control_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_retry_policy_status,
        ref_value=run_state.scheduler_retry_policy_ref,
        blocker_values=list(run_state.scheduler_retry_policy_blockers),
        fallback="scheduler_retry_policy_not_ready",
        ref_missing="scheduler_retry_policy_ref_missing",
        blockers_present="scheduler_retry_policy_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_cadence_status,
        ref_value=run_state.scheduler_cadence_ref,
        blocker_values=list(run_state.scheduler_cadence_blockers),
        fallback="scheduler_cadence_not_ready",
        ref_missing="scheduler_cadence_ref_missing",
        blockers_present="scheduler_cadence_blockers_present",
    )
    extend_if_not_ready(
        status_value=run_state.scheduler_recovery_runbook_status,
        ref_value=run_state.scheduler_recovery_runbook_ref,
        blocker_values=list(run_state.scheduler_recovery_runbook_blockers),
        fallback="scheduler_recovery_runbook_not_ready",
        ref_missing="scheduler_recovery_runbook_ref_missing",
        blockers_present="scheduler_recovery_runbook_blockers_present",
    )
...
def _validate_usdc_pair_allowlist_run_state_live_submit(
    *,
    ...
    if (
        run_state.runtime_fanout_price_freshness_status
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_PRICE_FRESHNESS_BLOCKED_STATUS
    ):
        blockers.append("run_state_runtime_fanout_price_freshness_not_blocked")
    if run_state.runtime_fanout_price_freshness_ref:
        blockers.append("run_state_runtime_fanout_price_freshness_ref_present")
    runtime_fanout_price_freshness_blockers = list(
        run_state.runtime_fanout_price_freshness_blockers
    )
    if (
        runtime_fanout_price_freshness_blockers
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_PRICE_FRESHNESS_BLOCKERS
        ...
        blockers.append(
            "run_state_runtime_fanout_price_freshness_blockers_mismatch"
        )
    if any(
        blocker not in runtime_fanout_price_freshness_blockers
    ...
    if (
        run_state.runtime_fanout_admission_audit_status
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_ADMISSION_AUDIT_BLOCKED_STATUS
    ):
        blockers.append("run_state_runtime_fanout_admission_audit_not_blocked")
    if run_state.runtime_fanout_admission_audit_ref:
        blockers.append("run_state_runtime_fanout_admission_audit_ref_present")
    runtime_fanout_admission_audit_blockers = list(
        run_state.runtime_fanout_admission_audit_blockers
    )
    if (
        runtime_fanout_admission_audit_blockers
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_ADMISSION_AUDIT_BLOCKERS
    ):
        blockers.append("run_state_runtime_fanout_admission_audit_blockers_mismatch")
    if any(
        blocker not in runtime_fanout_admission_audit_blockers
    ...
    if (
        ...
        blockers.append("run_state_runtime_fanout_retry_recovery_not_blocked")
    if run_state.runtime_fanout_retry_recovery_ref:
        blockers.append("run_state_runtime_fanout_retry_recovery_ref_present")
    runtime_fanout_retry_recovery_blockers = list(
        run_state.runtime_fanout_retry_recovery_blockers
    )
    if (
        runtime_fanout_retry_recovery_blockers
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_RETRY_RECOVERY_BLOCKERS
        ...
        blockers.append(
            "run_state_runtime_fanout_retry_recovery_blockers_mismatch"
        )
    if any(
        blocker not in runtime_fanout_retry_recovery_blockers
    ...
    if (
        run_state.runtime_fanout_rate_limit_status
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_RATE_LIMIT_BLOCKED_STATUS
    ):
        blockers.append("run_state_runtime_fanout_rate_limit_not_blocked")
    if run_state.runtime_fanout_rate_limit_ref:
        blockers.append("run_state_runtime_fanout_rate_limit_ref_present")
    runtime_fanout_rate_limit_blockers = list(
        run_state.runtime_fanout_rate_limit_blockers
    )
    if (
        runtime_fanout_rate_limit_blockers
        != USDC_PAIR_SNAPSHOT_RUNTIME_FANOUT_RATE_LIMIT_BLOCKERS
    ):
        blockers.append("run_state_runtime_fanout_rate_limit_blockers_mismatch")
    if any(
        blocker not in runtime_fanout_rate_limit_blockers
    ...
    if (
        run_state.scheduler_wallet_ledger_status
        != USDC_PAIR_SNAPSHOT_SCHEDULER_WALLET_LEDGER_BLOCKED_STATUS
    ):
        blockers.append("run_state_scheduler_wallet_ledger_not_blocked")
    if run_state.scheduler_wallet_ledger_ref:
        blockers.append("run_state_scheduler_wallet_ledger_ref_present")
    scheduler_wallet_ledger_blockers = list(
        run_state.scheduler_wallet_ledger_blockers
    )
    if (
        scheduler_wallet_ledger_blockers
        != USDC_PAIR_SNAPSHOT_SCHEDULER_WALLET_LEDGER_BLOCKERS
    ):
        blockers.append("run_state_scheduler_wallet_ledger_blockers_mismatch")
    if any(
        blocker not in scheduler_wallet_ledger_blockers
    ...
    if (
        run_state.scheduler_rate_limit_status
        != USDC_PAIR_SNAPSHOT_SCHEDULER_RATE_LIMIT_BLOCKED_STATUS
    ):
        blockers.append("run_state_scheduler_rate_limit_not_blocked")
    if run_state.scheduler_rate_limit_ref:
        blockers.append("run_state_scheduler_rate_limit_ref_present")
    scheduler_rate_limit_blockers = list(run_state.scheduler_rate_limit_blockers)
    if (
        scheduler_rate_limit_blockers
        != USDC_PAIR_SNAPSHOT_SCHEDULER_RATE_LIMIT_BLOCKERS
    ):
        blockers.append("run_state_scheduler_rate_limit_blockers_mismatch")
    if any(
        blocker not in scheduler_rate_limit_blockers
        for blocker in USDC_PAIR_SNAPSHOT_SCHEDULER_RATE_LIMIT_BLOCKERS
    ):
        blockers.append("run_state_scheduler_rate_limit_blockers_missing")
    if (
        run_state.scheduler_runtime_control_status
        != USDC_PAIR_SNAPSHOT_SCHEDULER_RUNTIME_CONTROL_BLOCKED_STATUS
    ):
        blockers.append("run_state_scheduler_runtime_control_not_blocked")
    if run_state.scheduler_runtime_control_ref:
        blockers.append("run_state_scheduler_runtime_control_ref_present")
    scheduler_runtime_control_blockers = list(
        run_state.scheduler_runtime_control_blockers
    )
    if (
        scheduler_runtime_control_blockers
        != USDC_PAIR_SNAPSHOT_SCHEDULER_RUNTIME_CONTROL_BLOCKERS
    ):
        blockers.append("run_state_scheduler_runtime_control_blockers_mismatch")
    if any(
        blocker not in scheduler_runtime_control_blockers
