"""Bridge between OrderEngine and OrderProcessor.

Provides order processing utilities that OrderEngine uses.
Wraps OrderProcessor to provide the expected interface.
