"""Main OrderEngine integration module.

Integrates Phase 3 business logic modules (OrderCalculator, OrderProcessor,
EventProcessor) into OrderEngine by wrapping and delegating.

This module preserves backward compatibility while leveraging specialized
business logic modules for calculations, processing, and event handling.
...
class OrderEngineIntegration:
    """Wraps OrderEngine with Phase 3 business logic module integration.
    
    This class delegates to the wrapped OrderEngine while providing
    integrated access to business logic modules for:
    ...
    def __init__(self, engine):
        ...
        Args:
            engine: OrderEngine instance to wrap and integrate with.
        """
        self.engine = engine
