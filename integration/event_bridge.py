"""Bridge between OrderEngine and EventProcessor.

Provides event deduplication and filtering utilities.
Wraps EventProcessor to provide the expected interface.
